...
{
    public sealed class LightedEffect2 : IDisposable
    {
        ...
        public LightedEffect2(IGraphicsDevice graphicsDevice, IObjectFactory objectFactory, IShadersRepository shadersRepository)
        {
            viewProjectionMatrix = Matrix.Identity;
            worldMatrix = Matrix.Identity;
            this.graphicsDevice = graphicsDevice;

            pntVertexShader = CreateVertexShader("Lighted2PNT", VertexPNT.Content, shadersRepository, objectFactory);
            pntPixelShader = CreatePixelShader("Lighted2PNT", shadersRepository, objectFactory);
        }
